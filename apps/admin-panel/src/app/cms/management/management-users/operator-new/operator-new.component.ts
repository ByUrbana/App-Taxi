...
import { CreateOperatorGQL, NewOperatorQuery } from '@urbana/admin-panel/generated/graphql';
import { COUNTRY_CODE_LIST } from '@urbana/admin-panel/src/app/country-codes';
