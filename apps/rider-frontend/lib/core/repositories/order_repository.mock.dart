      ...
      CalculateFareResponse(
        ...
        paymentGateways: const [
          PaymentGatewayEntity(
            id: "1",
            name: "PayPal",
            logoUrl: "https://uploads.urbana.io/urbana-demo/paypal.png",
            linkMethod: GatewayLinkMethod.redirect,
          ),
          PaymentGatewayEntity(
            id: "2",
            name: "Stripe",
            logoUrl: "https://uploads.urbana.io/urbana-demo/stripe.png",
          ...
          const ServiceCategoryEntity(
            ...
            services: [
              ServiceEntity(
                ...
                imageUrl: "https://uploads.urbana.io/urbana-demo/taxi-1.png",
                capacity: 3,
                price: 25,
              ...
              ServiceEntity(
                ...
                name: "Ride X",
                description: "Regular taxi",
                imageUrl: "https://uploads.urbana.io/urbana-demo/taxi-2.png",
                capacity: 4,
                price: 30,
              ...
              ServiceEntity(
                ...
                name: "Ride XL",
                description: "Regular taxi",
                imageUrl: "https://uploads.urbana.io/urbana-demo/taxi-3.png",
                capacity: 5,
                price: 35,
